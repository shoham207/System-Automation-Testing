...
//add to wishlist(session, {product name, quantity})

//=== for admin ===
//change product quantity(session,{product name, quantity})
//

// defineAction('userLogin',function(session, user){
//     session.click('//div[2]/div[1]/a[1]/span[1]')
//     session.writeText('//section[1]/form[1]/div[1]/div[1]/div[1]/input[1]',user.email)
//     session.writeText('//*[@id="field-password"]',user.password)
//     session.click('//*[@id="submit-login"]')
...
// defineAction('addToWishList' ,function(session, product){
//     session.click('//section[1]/section[1]/div[1]/div[8]/article[1]/div[1]/div[1]/a[1]/picture[1]/img[1]')
//     for (let i = 1; i < product.quantity; i++) {
//         session.click('//div[1]/div[1]/div[1]/span[3]/button[1]/i[1]')
//     }
// /*    session.clear('//div[2]/div[1]/div[1]/div[1]/input[1]')
//     session.writeText('//div[2]/div[1]/div[1]/div[1]/input[1]', product.quantity)*/
//     session.click('//div[2]/div[1]/button[1]/i[1]')
//     session.click('//ul[1]/li[1]/p[1]')
// })



// defineAction('adminLogin',function(session, user){
//     session.writeText('//div[1]/form[1]/div[1]/input[1]',user.email)
//     session.writeText('//div[2]/input[1]',user.password)
//     session.click('//form[1]/div[3]/button[1]')
// })

// defineAction('changeQuantity',function(session,product){

// // ################### 7ALLENA EL MOSHKLE!!!! ###################

// /*              ================ this case is when we have small window ================
//     session.click('//body/header[1]/nav[1]/i[1]') //click the 3 lines
//     session.click('//nav[1]/div[1]/ul[1]/li[5]/a') //catalog
//     session.click('//nav[1]/div[1]/ul[1]/li[5]/ul[1]/li[1]/a[1]') //Products*/

// //              ================ this case is when we have max window ================
...
//     session.clear('//div[1]/form[2]/table[1]/thead[1]/tr[2]/td[4]/input[1]')
//     session.writeText('//div[1]/form[2]/table[1]/thead[1]/tr[2]/td[4]/input[1]',product.name) // search box
//     session.click('//div[1]/form[2]/table[1]/thead[1]/tr[2]/td[11]/button[1]') //search product

//     session.click('//div[1]/form[2]/table[1]/tbody[1]/tr[1]/td[9]/a[1]') //quantity number
//     session.clear('//div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/input[1]')
//     session.writeText('//div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/input[1]',product.quantity)
//     session.click('//div[3]/form[1]/div[2]/div[1]/div[1]/div[1]/div[2]/button[1]') //save & publish
